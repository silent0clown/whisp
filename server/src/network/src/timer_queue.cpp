...
#include "timer.h"
// #include "timer.h" // Include the full definition of Timer
#include "timer_id.h"
...
void TimerQueue::insert(Timer* timer)
{
    ...
    //}
    //{
    //    std::pair<ActiveTimerSet::iterator, bool> result = activeTimers_.insert(ActiveTimer(timer,
    //    timer->sequence()));
    // assert(result.second); (void)result;
    //}
